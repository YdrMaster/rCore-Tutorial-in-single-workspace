...
use rcore_task_manage::{Manage, PThreadManager, Schedule, ProcId, ThreadId};

pub static mut PROCESSOR: PThreadManager<Process, Thread, ThreadManager, ProcManager> = PThreadManager::new();
